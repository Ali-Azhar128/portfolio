...
const ContactMe = () => {
  ...
  return (
    <div className='hidden1 logo w-full min-h-[80vh] max-w-[80%] md:max-w-[50%] m-auto flex flex-col justify-center items-center space-y-5' ref={sectionRef}>
        ...
        <p className='text-[#8892af] font-calibre text-center md:text-lg text-base leading-tight'>I’m currently exploring new opportunities, and my inbox is always open. Whether you have a role to discuss or just want to connect, feel free to reach out, and I’ll do my best to get back to you!</p>
